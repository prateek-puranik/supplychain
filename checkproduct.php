...
<html lang="en">
      ...
      <center>
		...
		<i class='fa fa-qrcode'></i> Scan QR
          ...
          <p id="database" class="cardstyle">
            No such Vaccine is manufactured.<br>Its a Counterfeit Vaccine.
          </p>
        </div>
      </center>
    </div>
  ...
  <?php }else{
    ...
    $("#aboutbtn").on("click", function(){
        showAlert("Our Course project is to keep track of a product throughout the supply chain and verify its authenticity.");
    });
