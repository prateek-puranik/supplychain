...
<html lang="en">
  <head>
    ...
    <title>Vaccine Tracking using Blockchain</title>
  ...
  <body class="violetgradient">
    ...
    $('#form1').on('submit', function(event) {
        ...
        web3.eth.getAccounts().then(async function(accounts) {
          ...
          .then(receipt => {
            console.log(receipt);
            if(receipt.events.Added.returnValues[0]===undefined)
            {
              console.log("Common Eroor");
            }
...
// Check product
  ...
  $("#aboutbtn").on("click", function(){
      showAlert("Our Course Project is to keep track of a vaccines throughout the supply chain and verify its authenticity.");
  });
