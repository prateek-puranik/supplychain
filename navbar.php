...
<img src="images/fibble.jpg" style="width: 30px;"> &nbsp
  ...
  <div class="collapse navbar-collapse" id="basicExampleNav">
    ...
    ?>
      <li class="nav-item">
        <a class="nav-link" href="checkproduct.php">Check Vaccine</a>
      </li>
    <?php
    if ( $_SESSION['role']==0 ){
    ?>
      <li class="nav-item">
        <a class="nav-link" href="addproduct.php">Add Vaccine</a>
      </li>
    <?php
        }if ( $_SESSION['role']==1 || $_SESSION['role']==0 ){
    ?>
      <li class="nav-item">
        <a class="nav-link" href="scanshipment.php">Scan Medicine</a>
      </li>
    <?php
    }
    }
